...
<html>
<head>
  <title><?php echo $_SESSION['post']['post_name'] ?></title>
   <!-- Basic -->
    <meta charset="utf-8" />
...
<body style="background-color: #f6f6f6;">
  ...
  <div class="hero_area" style="height: 100%;">
    ...
    <div class="container-fluid" style="margin-top: 50px;">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-12 col-xl-5 border" style="background-color: white;border-radius: 10px;">
          <h4 style="color: green;font-size: 30px;"><?php echo $_SESSION['post']['post_name']; ?></h4>
          <p>Ոլորտ - <?php echo $_SESSION['post']['type'] ?></p>
          <br>
          <div>
            <textarea style="width: 100%;height: 200px;color: black;" disabled><?php echo $_SESSION['post']['full_post']; ?></textarea>
          </div>
          <br>
          <div class="row">
            <div class="userAvatar col-2 col-xl-2">
              <h3><?php echo $_SESSION['post']['user_name'][0] ?></h3>
            </div>
            <div class="col-10">
              <p><?php echo $_SESSION['post']['user_name'] ?></p>
              <p>Հեռ. - <?php echo $_SESSION['post']['tel_num']; ?></p>
              <p style="text-align: right;"><?php echo $_SESSION['post']['data'] ?></p>

            </div>
          </div>
        </div>
        <div class="col-md-12 col-sm-12 col-12 col-xl-6 border" style="background-color: white;border-radius: 10px;margin-top: 20px;">
          <h2 style="text-align: center;margin-bottom: 20px;">Առաջարկություններ</h2>
          <div class="container">
          ...
          <?php 
            require_once "Login_v1/components/select.php";
            $type = $_SESSION['post']['type'];
            $user_type = $_SESSION['post']['user_type'];
            new select("type = '$type' AND user_type != '$user_type'", true);
           ?>
        </div>
